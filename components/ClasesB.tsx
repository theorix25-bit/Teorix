...
const Lessons = () => {
  ...
  const licenseData = type ? lessonsByType[type] : null;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="flex flex-col justify-center space-y-6">
            ...
            <p className="text-md md:text-xl text-muted-foreground leading-relaxed">
              Descripción completa sobre el {licenseData.name}. Este curso te
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {licenseData.lessons
              .filter((lesson: any) => {
                ...
                if (selectedFilter === "completados") return lesson.completed;
                if (selectedFilter === "pendientes")
                  return !lesson.completed && !lesson.locked;
                if (selectedFilter === "bloqueados") return lesson.locked;
                return true;
              })
              .map((lesson: any) => (
                <Card
                  ...
                  onClick={() => {
                    if (!lesson.locked) {
                      // navigate.push(`/tema/${type}/${lesson.id}`);
                      navigate.push(`/clases/tema/`);
                    }
                  }}
                >
